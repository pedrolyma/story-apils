package com.storyapils.exceptionhandler;
...
@ControllerAdvice
public class storyapilsExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleDataIntegrityViolationExcetion(DataIntegrityViolationException ex, WebRequest request) {
